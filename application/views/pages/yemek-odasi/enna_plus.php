                ...
                <div class="row align-items-center"> 
                    <div class="col-12 breadcrumb breadcrumb-style-01 fs-14 alt-font">
                        <ul>
                            ...
                            <li>Enna Plus <?= __('dining_room_set')?></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="row overflow-hidden position-relative">
                                ...
                                <div class="swiper product-image-slider" data-slider-options='{ "spaceBetween": 0, "watchOverflow": true, "navigation": { "nextEl": ".slider-product-next", "prevEl": ".slider-product-prev" }, "thumbs": { "swiper": { "el": ".product-image-thumb", "slidesPerView": "5", "spaceBetween": 15 } } }' data-swiper-thumb-click="1">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/enna-plus/2.png')?>" data-group="lightbox-gallery" title="Enna-1">
                                                <img class="w-100" src="<?= base_url('assets/images/enna-plus/1.png')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item -->
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/enna-plus/3.png')?>" data-group="lightbox-gallery" title="Enna-2">
                                                <img class="w-100" src="<?= base_url('assets/images/enna-plus/3.png')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item -->
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/enna-plus/4.png')?>" data-group="lightbox-gallery" title="Enna-3">
                                                <img class="w-100" src="<?= base_url('assets/images/enna-plus/4.png')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item -->
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/enna-plus/5.png')?>" data-group="lightbox-gallery" title="Enna-4">
                                                <img class="w-100" src="<?= base_url('assets/images/enna-plus/5.png')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item -->
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/enna-plus/6.png')?>" data-group="lightbox-gallery" title="Enna-5">
                                                <img class="w-100" src="<?= base_url('assets/images/enna-plus/6.png')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item --> 
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/enna-plus/7.png')?>" data-group="lightbox-gallery" title="Enna-6">
                                                <img class="w-100" src="<?= base_url('assets/images/enna-plus/7.png')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item --> 
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/enna-plus/8.png')?>" data-group="lightbox-gallery" title="Enna-7">
                                                <img class="w-100" src="<?= base_url('assets/images/enna-plus/8.png')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item --> 
                                    </div>
                            ...
                            <div class="col-12 position-relative">
                                <div class="swiper-container product-image-thumb">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/enna-plus/1.png')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/enna-plus/3.png')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/enna-plus/4.png')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/enna-plus/5.png')?>" alt=""></div> 
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/enna-plus/6.png')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/enna-plus/7.png')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/enna-plus/8.png')?>" alt=""></div>
                                    </div>
                                </div> 
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 offset-lg-1 product-info" data-anime='{ "translate": [0, 0], "opacity": [0,1], "duration": 600, "delay": 100, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        ...
                        <h5 class="alt-font text-dark-gray fw-700 mb-10px">Enna Plus <?= __('dining_room_set')?> </h5>
                        
                        
                        <p><?= __('enna_plus_dining_content')?></p>
                            ...
                            <div class="tab-pane fade in active show" id="tab_five1">
                                <div class="row align-items-center justify-content-center mb-5 sm-mb-10">
                                    <div class="col-xl-4 col-lg-5 md-mb-40px">
                                        ...
                                        <h4 class="alt-font text-dark-gray fw-700 mb-20px">Enna Plus<?= __('dining_room_set')?></h4>
                                        <p><?= __('enna_plus_tab_explanation_content')?> </p>
                                        <div>
                                            <div class="feature-box feature-box-left-icon-middle mb-10px">
                                                ...
                                                <div class="feature-box-content"> 
                                                    <span class="d-block text-dark-gray fw-500"><?= __('enna_plus_tab_explanation_row_1')?></span>
                                                </div>
                                            </div>
                                            <div class="feature-box feature-box-left-icon-middle mb-10px">
                                                <div class="feature-box-icon feature-box-icon-rounded w-30px h-30px rounded-circle bg-very-light-gray me-10px">
                                                ...
                                                <div class="feature-box-content"> 
                                                    <span class="d-block text-dark-gray fw-500"><?= __('enna_plus_tab_explanation_row_2')?></span>
                                                </div>
                                            </div>
                                            <div class="feature-box feature-box-left-icon-middle mb-10px">
                                                <div class="feature-box-icon feature-box-icon-rounded w-30px h-30px rounded-circle bg-very-light-gray me-10px">
                                                ...
                                                <div class="feature-box-content"> 
                                                    <span class="d-block text-dark-gray fw-500"><?= __('enna_plus_tab_explanation_row_3')?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-7 offset-xl-1">
                                        <img src="<?= base_url('assets/images/enna-plus/1.png')?>" alt="" class="w-100" />
                                    </div>
                                </div>
