            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="row overflow-hidden position-relative">
                                ...
                                <div class="swiper product-image-slider" data-slider-options='{ "spaceBetween": 0, "watchOverflow": true, "navigation": { "nextEl": ".slider-product-next", "prevEl": ".slider-product-prev" }, "thumbs": { "swiper": { "el": ".product-image-thumb", "slidesPerView": "5", "spaceBetween": 15 } } }' data-swiper-thumb-click="1">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/asya-yasam/ASYA-1.jpg')?>" data-group="lightbox-gallery" title="Asya-1">
                                                <img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-1.jpg')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item -->
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/asya-yasam/ASYA-2.jpg')?>" data-group="lightbox-gallery" title="Asya-2">
                                                <img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-2.jpg')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item -->
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/asya-yasam/ASYA-3.jpg')?>" data-group="lightbox-gallery" title="Asya-3">
                                                <img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-3.jpg')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item -->
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/asya-yasam/ASYA-4.jpg')?>" data-group="lightbox-gallery" title="Asya-4">
                                                <img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-4.jpg')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item -->
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/asya-yasam/ASYA-5.jpg')?>" data-group="lightbox-gallery" title="Asya-5">
                                                <img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-5.jpg')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item --> 
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/asya-yasam/ASYA-6.jpg')?>" data-group="lightbox-gallery" title="Asya-6">
                                                <img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-6.jpg')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item --> 
                                        <div class="swiper-slide gallery-box">
                                            <a href="<?= base_url('assets/images/asya-yasam/ASYA-7.jpg')?>" data-group="lightbox-gallery" title="Asya-7">
                                                <img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-7.jpg')?>" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item --> 
                                    </div>
                            ...
                            <div class="col-12 position-relative">
                                <div class="swiper-container product-image-thumb">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-1.jpg')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-2.jpg')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-3.jpg')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-4.jpg')?>" alt=""></div> 
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-5.jpg')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-6.jpg')?>" alt=""></div>
                                        <div class="swiper-slide"><img class="w-100" src="<?= base_url('assets/images/asya-yasam/ASYA-7.jpg')?>" alt=""></div>
                                    </div>
                                </div> 
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 offset-lg-1 product-info" data-anime='{ "translate": [0, 0], "opacity": [0,1], "duration": 600, "delay": 100, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        ...
                        <h5 class="alt-font text-dark-gray fw-700 mb-10px"><?= __('asya_dining_room_set')?></h5>
                        
                        
                        <p><?= __('asya_dining_content')?></p>
                ...
                <div class="row">
                    <div class="col-12 tab-style-04" data-anime='{ "translate": [0, 0], "opacity": [0,1], "duration": 600, "delay": 100, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <ul class="nav nav-tabs border-0 justify-content-center alt-font fs-17 fw-500">
                            <li class="nav-item"><a data-bs-toggle="tab" href="#tab_five1" class="nav-link active"><?=__('explanation_title')?><span class="tab-border bg-dark-gray"></span></a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab_five2"><?=__('dimension_title')?><span class="tab-border bg-dark-gray"></span></a></li>
                            ...
                            <div class="tab-pane fade in active show" id="tab_five1">
                                <div class="row align-items-center justify-content-center mb-5 sm-mb-10">
                                    <div class="col-xl-4 col-lg-5 md-mb-40px">
                                        ...
                                        <h4 class="alt-font text-dark-gray fw-700 mb-20px"><?= __('asya_dining_room_set')?></h4>
                                        <p><?= __('asya_explanation_content')?></p>
                                        <div>
                                            <div class="feature-box feature-box-left-icon-middle mb-10px">
                                                ...
                                                <div class="feature-box-content"> 
                                                    <span class="d-block text-dark-gray fw-500"><?= __('asya_explanation_row_1')?></span>
                                                </div>
                                            </div>
                                            <div class="feature-box feature-box-left-icon-middle mb-10px">
                                                <div class="feature-box-icon feature-box-icon-rounded w-30px h-30px rounded-circle bg-very-light-gray me-10px">
                                                ...
                                                <div class="feature-box-content"> 
                                                    <span class="d-block text-dark-gray fw-500"><?= __('asya_explanation_row_2')?></span>
                                                </div>
                                            </div>
                                            <div class="feature-box feature-box-left-icon-middle mb-10px">
                                                <div class="feature-box-icon feature-box-icon-rounded w-30px h-30px rounded-circle bg-very-light-gray me-10px">
                                                ...
                                                <div class="feature-box-content"> 
                                                    <span class="d-block text-dark-gray fw-500"><?= __('asya_explanation_row_3')?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-7 offset-xl-1">
                                        <img src="<?= base_url('assets/images/asya-yasam/ASYA-2.jpg')?>" alt="" class="w-100" />
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade in" id="tab_five2">
                                ...
                                <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0"><?= __('width')?> 75 | <?= __('depth')?> 75 | <?= __('height')?>44</div>
                                        </div>
                                        <div class="row">
                                        <div class="col-lg-2 col-md-3 col-sm-4 pt-10px pb-10px xs-pb-0 text-dark-gray alt-font fw-600"></div>
                                            <div class="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0"><?= __('width')?> 50 | <?= __('depth')?> 50 | <?= __('height')?>55</div>
                                        </div>
                                        <div class="row bg-very-light-gray">
                                            <div class="col-lg-2 col-md-3 col-sm-4 pt-10px pb-10px xs-pb-0 text-dark-gray alt-font fw-600"><?= __('tv_sub_block')?></div>
                                            <div class="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0"><?= __('width')?> 200 | <?= __('depth')?> 45 | <?= __('height')?>63</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
